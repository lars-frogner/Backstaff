...
def run_command(
    command, return_immediately=False, logger=print, error_logger=print, **kwargs
):
...
def run_backstaff_remotely(
    ...
    **kwargs
    ...
    args = pre_ssh_args + ["ssh", destination_machine, " ".join(remote_command_args)]
    return run_command(args, **kwargs)
