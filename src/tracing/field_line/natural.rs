...
use super::super::{ftr, trace_3d_field_line, TracerResult};
...
mod tests {
    ...
    fn tracing_and_saving_natural_field_line_works() {
        ...
        field_line_23
            .save_as_pickle("data/natural_field_line_23.pickle")
            .unwrap();
        field_line_45
            .save_as_pickle("data/natural_field_line_45.pickle")
            .unwrap();
    }
    ...
    fn tracing_and_saving_natural_field_line_set_works() {
        ...
        let field_line_set = FieldLineSet3::trace(
            seeder,
            &|| DualNaturalFieldLine3::new(None),
            &magnetic_field,
            &interpolator,
            stepper_factory,
        )
